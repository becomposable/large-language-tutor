 ...
 */
const toRawRomaji = function (str: string, system?: ROMANIZATION_SYSTEM) {
    system = system || ROMANIZATION_SYSTEM.HEPBURN;

    const romajiSystem: {
        nippon: Record<string, string>,
        passport: Record<string, string>,
        hepburn: Record<string, string>
    } = {
        nippon: {
            // 数字と記号
            "１": "1",
 ...
 */
const patchTokens = function (tokens: IToken[]) {
 ...
 * @return {string} Romaji string
 */
const kanaToRomaji = function (str: string, system: ROMANIZATION_SYSTEM) {

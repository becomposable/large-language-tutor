import { IOptions, IToken } from "./types.js";
import {
    ROMANIZATION_SYSTEM,
    getStrType,
    patchTokens,
...
class Kuroshiro {
     ...
     */
    async convert(str: string, options: IOptions) {
        options = options || {};
        ...
        const ROMAJI_SYSTEMS = Object.keys(ROMANIZATION_SYSTEM).map(e => (ROMANIZATION_SYSTEM as any)[e]);
        ...
        return this.convertTokens(rawTokens, options);
    }

    async convertTokens(rawTokens: IToken[], options: IOptions) {

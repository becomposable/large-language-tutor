...
export const MessageSchema = new mongoose.Schema<IMessage>(
  {
    ...
    origin: {
      type: String,
      enum: Object.values(MessageOrigin),
      required: true,
    },
    in_reply_to: {
      type: ObjectId,
...
export type MessageDocument = mongoose.Document<ObjectIdType, any, IMessage> &
  IMessage;
...
export function findPreviousMessages(
  conversationId: ObjectIdType,
  props: FindPreviousMessageOptions = {}
): Promise<IMessage[]> {
